/* ============================================================
   shared.js — Auth, Storage, Currency & Global UI
   Wallet Nakama — Merged: Dave's logic + Iman's currency list
   ============================================================ */
'use strict';

/* ── Currency Config (Iman's list + Dave's conversion logic) ── */
const RATES_TO_NGN = { NGN: 1, USD: 1600, GBP: 2050, EUR: 1750 };
...
const CATEGORY_ICONS = {
  'Salary': '💼', 'Freelance / Side Hustle': '💻', 'Investments': '📈',
  'Rental Income': '🏠', 'Others': '📦', 'Rent': '🏠', 'Groceries': '🛒',
  'Healthcare': '🏥', 'Transportation': '🚗', 'Utilities': '💡',
  'Insurance': '🛡️', 'Savings & Investments': '🏦'
};
...
function getSymbol() { return CURRENCY_SYMBOLS[globalCurrency] || '$'; }
...
function hashish(str) { let h = 0; for (let i = 0; i < str.length; i++) { h = ((h << 5) - h) + str.charCodeAt(i); h |= 0; } return h.toString(36); }
